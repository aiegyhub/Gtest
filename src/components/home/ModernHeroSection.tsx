...
const ModernHeroSection = ({ 
  ...
  return (
    <section className="relative min-h-[90vh] bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 overflow-hidden pt-20">
            ...
            <div className="space-y-4">
              ...
              <h1 className="text-4xl md:text-6xl font-bold leading-tight">
                ...
                <span className="text-gray-800">
                  دليلك المتخصص للخدمات المنزلية
                </span>
              </h1>
          ...
          <div className="space-y-6">
            <Card className="bg-white/80 backdrop-blur-sm border-0 shadow-lg hover:shadow-xl transition-all duration-300">
              <CardContent className="p-6">
                <h3 className="text-lg font-semibold mb-4 text-center">أو اختر خدمة مباشرة:</h3>
            ...
            <Card className="bg-gradient-to-r from-orange-500 to-amber-500 text-white border-0 shadow-xl">
              <CardContent className="p-6 text-center">
                <div className="flex items-center justify-center gap-2 mb-4">
                  ...
                  <h3 className="text-xl font-bold">توصيات الذكاء الاصطناعي</h3>
                </div>
                <p className="mb-4">احصل على توصيات مخصصة لاحتياجاتك</p>
                <Button 
                  variant="secondary" 
